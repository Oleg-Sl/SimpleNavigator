#ifndef SIMPLE_NAVIGATOR_MODEL_TRAVELING_SALESMAN_ANNEALING_PARAMS_H
#define SIMPLE_NAVIGATOR_MODEL_TRAVELING_SALESMAN_ANNEALING_PARAMS_H
...
#endif  // SIMPLE_NAVIGATOR_MODEL_TRAVELING_SALESMAN_ANNEALING_PARAMS_H